            ...
            <div className="bg-gradient-to-r from-pink-100 to-cyan-100 text-center">
                ...
                <div className="bg-white rounded-lg shadow-lg p-8 m-14">
                    <div className="text-gray-800">
                        {/* Replace placeholder content with actual description */}
                ...
                <div className="bg-white rounded-lg shadow-lg p-8 m-14">
                    <div className="text-gray-800">
                        {/* Replace placeholder content with actual activities */}
                ...
                <div className="bg-white rounded-lg shadow-lg p-8 m-14">
                    <div className="text-gray-800">
                        {/* Replace placeholder content with actual achievements */}
                        <ul className="list-disc list-inside space-y-2">
                            <li>学内コンテスト最優秀賞受賞</li>
                ...
                <div className="bg-white rounded-lg shadow-lg p-8 m-14">
                    <div className="text-gray-800">
                        {/* Replace placeholder content with actual equipment */}
                        <ul className="list-disc list-inside space-y-2">
                            <li>高性能デザインPC</li>
                ...
                <div className="p-4 m-4 text-gray-800">
                    <div>※注意事項：新入生歓迎会への参加は事前登録が必要です。詳細は代表者までお問い合わせください。</div>
                </div>
            </div>
            <Footer />
        </div>
